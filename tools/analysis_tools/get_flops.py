...
def inference(args, logger):
    ...
    mean_flops = np.average(avg_flops)
...
def format_with_precision(value, precision=5):
...
def format_flops(value):
    """Format FLOPs with five decimal places."""
    return format_with_precision(value, precision=5)


def format_params(value):
    """Format params with default precision."""
    return format_with_precision(value, precision=5)
