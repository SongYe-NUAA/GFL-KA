...
launcher = 'none'
load_from = 'runs/sota/efficientnet/best_coco_bbox_mAP_epoch_12.pth'
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    ...
    type='RetinaNet')
norm_cfg = dict(_scope_='mmdet', requires_grad=True, type='BN')
num_classes = 19
optim_wrapper = dict(
    _scope_='mmdet',
    clip_grad=None,
...
work_dir = './runs/sota/efficientnet'
