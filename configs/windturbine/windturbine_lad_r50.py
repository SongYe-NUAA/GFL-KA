...
launcher = 'none'
load_from = 'runs/sota/lad/best_coco_bbox_mAP_epoch_12.pth'
log_level = 'INFO'
log_processor = dict(
...
model = dict(
    ...
    teacher_bbox_head=dict(
        ...
        type='LADHead'),
    teacher_ckpt=
    'http://download.openmmlab.com/mmdetection/v2.0/paa/paa_r101_fpn_1x_coco/paa_r101_fpn_1x_coco_20200821-0a1825a4.pth',
    teacher_neck=dict(
        add_extra_convs='on_output',
        in_channels=[
            256,
