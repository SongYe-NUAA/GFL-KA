...
train_dataset = dict(
    ...
    dataset=dict(
        ...
        pipeline=train_pipeline),  # 使用基础 pipeline
    pipeline=train_pipeline_stage1)  # 使用增强 pipeline
...
train_cfg = dict(max_epochs=max_epochs, val_interval=save_epoch_intervals)
...
train_cfg = dict(
    ...
    val_interval=save_epoch_intervals,  # 每隔多少个epoch验证一次
    val_begin=5)     # 从第几个epoch开始验证
