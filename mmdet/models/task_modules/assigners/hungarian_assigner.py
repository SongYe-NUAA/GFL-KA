...
class HungarianAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        # Replace NaN and Inf values with large finite values to ensure
        # linear_sum_assignment works correctly. This can happen when:
        # - img_shape has invalid values (e.g., 0) causing div by zero
        # - bbox predictions/GT have degenerate coordinates
